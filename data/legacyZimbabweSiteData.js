export const legacyPrayerContacts = [
  {
  ...
  {
    id: 'prayer-whatsapp-2',
    label: 'Prayer Requests WhatsApp',
    value: '+263 780 862 668',
    href: 'https://wa.me/263780862668',
  },
];
...
export const legacyZimbabweWebcast = {
  ...
  zoomMeetingId: '850 8805 6383',
  zoomPasscode: '111',
  calendarTitle: '2024 - 2025 Church Calendar',
  calendarNote:
    'Schedules for camp meetings to be held in other countries will be displayed closer to the dates.',
};

export const legacyZimbabweBranches = [
  { id: 0, name: 'Harare', address: 'Stand 10466, Lusaka, Highfields', pastor: 'N Jaravani' },
  { id: 1, name: 'Chinhoyi', address: 'TBC', pastor: 'S Zulu' },
  { id: 2, name: 'Banket', address: 'TBC', pastor: 'T Kawazi' },
  { id: 3, name: 'Chimwemwe', address: 'TBC', pastor: 'O Dzimati' },
  { id: 4, name: 'Kasanze', address: 'TBC', pastor: 'J Murondi' },
  { id: 5, name: 'Karoi', address: 'TBC', pastor: 'B Nyamuzihwa' },
  { id: 6, name: 'Chegutu', address: 'TBC', pastor: 'J Mapfumo' },
  { id: 7, name: 'Kariba', address: 'TBC', pastor: 'M Amupasu' },
  ...
  { id: 15, name: 'Kadoma', address: 'TBC', pastor: 'N Zurura' },
  { id: 16, name: 'Magunje', address: 'TBC', pastor: 'S Kusakadza' },
  { id: 17, name: 'Mujinga', address: 'TBC', pastor: 'S Chizanga' },
  { id: 18, name: 'Protea', address: 'TBC', pastor: 'T Phiri' },
  { id: 19, name: 'Nyamapipi', address: 'TBC', pastor: 'Rusike' },
  { id: 20, name: 'Lizmore', address: 'TBC', pastor: 'Marimbe' },
  { id: 21, name: 'Sadoma', address: 'TBC', pastor: 'A Manjini' },
  { id: 22, name: 'Deehurst', address: 'TBC', pastor: 'J Mareza' },
  { id: 23, name: 'Sachuru', address: 'TBC', pastor: 'L Shura' },
  { id: 24, name: 'Gweru', address: 'TBC', pastor: 'S Ngwenya' },
  { id: 25, name: 'Gweru', address: 'TBC', pastor: 'L Jenami' },
  { id: 26, name: 'Shurugwi', address: 'TBC', pastor: 'J Dhliwayo' },
  { id: 27, name: 'Kwekwe', address: 'TBC', pastor: 'B Mugumba' },
  { id: 28, name: 'Shurugwi', address: 'TBC', pastor: 'O Pulazi' },
  { id: 29, name: 'Gokwe', address: 'TBC', pastor: 'R Jongwe' },
  { id: 30, name: 'Kwekwe', address: 'TBC', pastor: 'C Muswere' },
  { id: 31, name: 'Chachacha', address: 'TBC', pastor: 'C Gavi' },
  { id: 32, name: 'Pakame', address: 'TBC', pastor: 'L Mahlahla' },
  { id: 33, name: 'Zvishavane', address: 'TBC', pastor: 'D Mumpande' },
  { id: 34, name: 'Gokwe', address: 'TBC', pastor: 'D Murambakanda' },
  { id: 35, name: 'Silobela', address: 'TBC', pastor: 'J Madziva' },
  { id: 36, name: 'Treetop', address: 'TBC', pastor: 'G Mhike' },
  { id: 37, name: 'Gweru', address: 'TBC', pastor: 'A Moyo' },
  { id: 38, name: 'Buchwa', address: 'TBC', pastor: 'A Shava' },
  { id: 39, name: 'Gokwe', address: 'TBC', pastor: 'E Makwiramiti' },
  { id: 40, name: 'Senga', address: 'TBC', pastor: 'D Magonde' },
  { id: 41, name: 'Hwange', address: 'TBC', pastor: 'F Ruvivi' },
  { id: 42, name: 'Inyathi', address: 'TBC', pastor: 'J Shupo' },
  { id: 43, name: 'Victoria Falls', address: 'TBC', pastor: 'V Sibanda' },
  { id: 44, name: 'Mambanje', address: 'TBC', pastor: 'R Mathe' },
  { id: 45, name: 'Binga', address: 'TBC', pastor: 'N Mwembe' },
  { id: 46, name: 'Masvingo City', address: 'TBC', pastor: 'A Chimeri' },
  { id: 47, name: 'Sarahuru Siding', address: 'TBC', pastor: 'M Zimbwa' },
  {
    id: 48,
    name: 'Triangle Nzimbe location',
    address: 'TBC',
    pastor: 'E Muchipi',
  },
  { id: 49, name: 'Gutu Mpandawana', address: 'TBC', pastor: 'E Machalaga' },
  { id: 50, name: 'Mutare', address: 'TBC', pastor: 'H Pasimupindu' },
  { id: 51, name: 'Rusape', address: 'TBC', pastor: 'T Matsika' },
  { id: 52, name: 'Mutare Dangamvura', address: 'TBC', pastor: 'Y Damalekani' },
  { id: 53, name: 'Mutare Chikanga', address: 'TBC', pastor: 'L Chitanga' },
];

export const legacyZimbabweCalendar = {
  title: legacyZimbabweWebcast.calendarTitle,
  note: legacyZimbabweWebcast.calendarNote,
  months: [
    {
      month: 'March 2025',
      items: [{ title: 'Provincial Overseers Meeting - Highfields', time: 'TBA' }],
    },
    {
      month: 'April 2025',
      items: [
        { title: 'Passover Meetings', time: 'Thursday Evening' },
        { title: 'Manicaland Provincial Camp - Mutare', time: '6-14 April' },
      ],
    },
    {
      month: 'May 2025',
      items: [{ title: "National Ladies Conference - Resthaven", time: 'TBA' }],
    },
    {
      month: 'June 2025',
      items: [{ title: "National Men's Conference - Resthaven", time: 'TBA' }],
    },
    {
      month: 'August 2025',
      items: [
        { title: 'Regional Youth Camp Meeting', time: '20-27 August' },
        { title: 'Crusades Meetings', time: '11-14 August' },
      ],
    },
    {
      month: 'December 2025',
      items: [{ title: 'Regional Camp Meeting', time: '3-17 December' }],
    },
  ],
};

export const legacyVideoArchive = [
  {
    id: 'video-1',
    date: '05.06.22',
    title: 'Jesus is still the answer',
    speaker: 'Bro. T. Msindazi',
    videoUrl: 'https://www.youtube.com/watch?v=P-dzi1J6ebc',
    type: 'Sermon Video',
  },
  {
    id: 'video-2',
    ...
    videoUrl: 'https://www.youtube.com/watch?v=qMFP57XuuGI&t=6920s',
    type: 'Sermon Video',
  },
  {
    id: 'video-3',
    date: '02.04.05',
    title: 'What more could Jesus do for you?',
    speaker: 'Bro. Mangere',
    videoUrl: 'https://www.youtube.com/watch?v=6F5zrPCp1ng',
    type: 'Sermon Video',
  },
  {
    id: 'video-4',
  ...
  },
  {
    ...
    date: '09.08.20',
    title: 'Living Faith',
    speaker: 'Bro. F. Panganayi',
    videoUrl: 'https://www.youtube.com/watch?v=oTFjLOp_aPs',
    type: 'Sermon Video',
  },
  {
    id: 'video-6',
    ...
    title: 'Jesus is still the answer',
    speaker: 'Rev. Toma',
    videoUrl: 'https://www.youtube.com/watch?v=h2NaH2beYbw',
    type: 'Sermon Video',
  },
];

export const legacyCampMeetingRecordings = [
  {
    id: 'camp-1-3-dec-2023',
    date: '3 Dec 2023',
    sessionName: 'Opening Service',
    title: 'Seeking Jesus',
  ...
  {
    id: 'camp-3-3-dec-2023',
    date: '3 Dec 2023',
    sessionName: 'Youth Service',
    title: 'Godly Youths',
  ...
  {
    id: 'camp-2-3-dec-2023',
    date: '3 Dec 2023',
    sessionName: 'Evangelistic Service',
    title: 'Seeing Jesus',
  ...
  {
    id: 'camp-5-5-dec-2023',
    date: '5 Dec 2023',
    sessionName: 'Bible Teaching',
    title: 'Repentance',
    speaker: 'Rev John Musgrave',
    audioUrl:
  ...
  {
    id: 'camp-6-5-dec-2023',
    date: '5 Dec 2023',
    sessionName: 'Children Service',
    title: 'Love of God',
  ...
  {
    id: 'camp-16-12-dec-2023',
    date: '12 Dec 2023',
    sessionName: "Children's Service",
    title: null,
  ...
  {
    id: 'camp-27-16-dec-2023',
    date: '16 Dec 2023',
    sessionName: 'Music Night',
    title: null,
    speaker: null,
    audioUrl:
  ...
  {
    id: 'camp-28-17-dec-2023',
    date: '17 Dec 2023',
    sessionName: 'Devotional Service',
