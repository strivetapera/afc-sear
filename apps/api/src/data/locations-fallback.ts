import type { LocationsDirectoryView } from '../modules';

export const fallbackLocationsMetadata: LocationsDirectoryView['metadata'] = {
  eyebrow: 'Locations',
  title: 'Zimbabwe Branch Directory',
  lead:
    'This directory carries forward restored Zimbabwe branch information while broader regional location data continues to be verified and added carefully.',
};

export const fallbackLocationsOverview: LocationsDirectoryView['overview'] = {
  intro:
    'The current platform fallback preserves a usable Zimbabwe directory view so visitors can still find the Harare assembly and understand the wider branch footprint under restoration.',
  contactPrompt:
...
export const fallbackLocationsContacts: LocationsDirectoryView['contacts'] = [
  {
    id: 'harare-address',
...
export const fallbackLocationsGroups: LocationsDirectoryView['groupedLocations'] = [
  {
    country: 'Zimbabwe',
    locations: [
      {
...
export const fallbackLocationsDirectory: LocationsDirectoryView = {
