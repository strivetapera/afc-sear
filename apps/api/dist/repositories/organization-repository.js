import { getLocationsDirectory as getSeedLocationsDirectory, listBranches as listSeedBranches, } from '../data/platform-store';
import { fallbackLocationsContacts, fallbackLocationsMetadata, fallbackLocationsOverview, } from '../data/locations-fallback';
